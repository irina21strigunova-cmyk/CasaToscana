...
export const boutiqueCategories: BoutiqueCategory[] = [
  ...
  },
  {
    slug: "fragrance",
    name: "Ароматы",
    subtitle: "Цветочные и цитрусовые ноты",
    collection: "06",
    image: "/categories/Ароматы.jpg",
    imagePosition: "center 48%",
    overlay: "rgba(150, 140, 160, 0.14)",
    layout: "tall",
  },
  {
    slug: "car-fragrance",
    ...
    collection: "07",
    image: "/categories/Аромадиффузоры для авто.jpg",
  ...
  },
  {
    ...
    name: "Аксессуары для тела",
    subtitle: "Ритуал мягкого очищения",
    collection: "09",
    image: "/categories/Аксессуары для тела.jpg",
    imagePosition: "center 48%",
    overlay: "rgba(168, 149, 120, 0.14)",
    layout: "hero",
  },
  {
    slug: "gift-sets",
